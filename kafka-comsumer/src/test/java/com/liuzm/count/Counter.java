...
public class Counter {
    ...
    public String printUriCountMap() {
        ...
        for (Entry<String, AtomicLong> entry : URI_COUNT_MAP.entrySet()) {
            builder.append("\n");
...
//            }
            ...
            for (int i = 0; i < 5; i++) c.incConn();
            for (int i = 0; i < 4; i++) c.decConn();
            for (int i = 0; i < 3; i++) c.incReq();
            for (int i = 0; i < 2; i++) c.incTimeout(500);
            for (int i = 0; i < 1; i++) c.addTime(99);
